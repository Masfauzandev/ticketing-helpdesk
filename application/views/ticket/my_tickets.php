    ...
    $(function () {
        ...
        var options = {
            ...
            datatable: {
                scrollX: false,
                autoWidth: false,
                dom: "<'row'<'col-md-6'B><'col-md-6'f>><'row'<'col-md-12 table-responsive'tr>><'row'<'col-md-5'i><'col-md-7'p>>",
                order: [[10, 'desc']],
                columns: [
                    {
                        title: "#",
                    ...
                    },
                    {
                        ...
                        data: "subject",
                        render: function (data) {
                            return data ? addBrAfterXWords(6, data) : '-';
                        }
                    },
                    {
                        title: "Title",
                    ...
                    },
                    {
                        ...
                        data: "category",
                        render: function (data) {
                            // Use single quotes for data-value to handle potentially JSON double quotes
