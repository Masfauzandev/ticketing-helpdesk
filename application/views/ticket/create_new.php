                            ...
                            <div class="col-md-12">
                                <form>
                                    <div class="form-group">
                                        <div class="row">
                                            <label class="col-sm-2 form-control-label" for="subject_dd">Subject</label>
                                            <div class="col-sm-6 select">
                                                <select name="subject" id="subject_dd" class="form-control" style="width: 100%" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <input id="title" type="text" name="title" required=""
                                                    class="form-control" placeholder="Title of the ticket">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 select">
                                                <select name="severity" id="severity_dd" class="form-control" style="width: 100%">
...
<script>
    $(document).ready(function () {
        ...
        $("#create_ticket").on('click', function (a) {
            a.preventDefault();
            var subjectVal = $("#subject_dd").val();
            var subject = subjectVal && subjectVal !== 'null' ? $("#subject_dd option:selected").text() : '';
            var title = $("#title").val();
            var message = quill.root.innerHTML
            var cc = ($("#cc_dd").val()).join(';');
            var severity = parseInt($("#severity_dd").val());
            var category = $("#category_dd").val();
            ...
            console.log(fdata);
            if (!subject || subjectVal === 'null' || !title || !message) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (res.data && res.data.result) {
                            ...
                            window.location.href = BASE_URL + "tickets/view_ticket/" + res.data.result;
                        } else {
                            $('#attached_files').html('');
