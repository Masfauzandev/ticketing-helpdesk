<div class="page login-page">
                        ...
                        <div class="content">
                            <form method="post" class="form-validate" action="">
                                <div class="form-group">
                                    ...
                                    <label for="login-username" class="label-material">User Neme</label>
                                </div>
                                <div class="form-group">
    ...
    <div class="copyrights text-center text-dark">
        <p>Powered by <a href="<?= BASE_URL ?>" class="external"><img src="/tiket-master/assets/img/logo-red.png" width="65" alt="AGA"></a></p>
    </div>
</div>