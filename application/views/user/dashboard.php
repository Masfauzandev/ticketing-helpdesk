            ...
            <div class="row">
                ...
                <a href="<?= BASE_URL ?>tickets/list_all" class="col-md-3">
                    <div class="statistic d-flex align-items-center bg-white has-shadow custom-border-radius">
                        ...
                        <div class="text">
                            <strong class="d-block"><?= $stats['total_tickets'] ?></strong>
                            <small class="text-uppercase">All Tickets</small>
                        </div>
                    </div>
                </a>
                ...
                <a href="<?= BASE_URL ?>tickets/open_tickets" class="col-md-3">
                    <div class="statistic d-flex align-items-center bg-white has-shadow custom-border-radius">
                        ...
                        <div class="text">
                            <strong class="d-block"><?= $stats['open_tickets'] ?></strong>
                            <small class="text-uppercase">Open Tickets</small>
                        </div>
                    </div>
                </a>
                ...
                <a href="<?= BASE_URL ?>tickets/in_progress_tickets" class="col-md-3">
                    <div class="statistic d-flex align-items-center bg-white has-shadow custom-border-radius">
                        ...
                        <div class="text">
                            <strong class="d-block"><?= $stats['in_progress_tickets'] ?></strong>
                ...
                <a href="<?= BASE_URL ?>tickets/assigned_tickets" class="col-md-3">
                    <div class="statistic d-flex align-items-center bg-white has-shadow custom-border-radius">
                        ...
                        <div class="text">
                            <strong class="d-block"><?= $stats['assigned_tickets'] ?></strong>
                            <small class="text-uppercase">Assigned Tickets</small>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="row mt-3">
                <a href="<?= BASE_URL ?>tickets/on_hold_tickets" class="col-md-3">
                    <div class="statistic d-flex align-items-center bg-white has-shadow custom-border-radius">
                        ...
                        <div class="text">
                            <strong class="d-block"><?= $stats['on_hold_tickets'] ?></strong>
                            <small class="text-uppercase">On Hold</small>
                        </div>
                    </div>
                </a>
                ...
                <a href="<?= BASE_URL ?>tickets/closed_tickets" class="col-md-3">
                    <div class="statistic d-flex align-items-center bg-white has-shadow custom-border-radius">
                        ...
                        <div class="text">
                            <strong class="d-block"><?= $stats['closed_tickets'] ?></strong>
                            <small class="text-uppercase">Closed Tickets</small>
                        </div>
                    </div>
                </a>
                ...
                <a href="<?= BASE_URL ?>tickets/cancelled_tickets" class="col-md-3">
                    <div class="statistic d-flex align-items-center bg-white has-shadow custom-border-radius">
                        ...
                        <div class="text">
                            <strong class="d-block"><?= $stats['cancelled_tickets'] ?></strong>
                            <small class="text-uppercase">Cancelled</small>
                        </div>
                    </div>
                </a>
            </div>
