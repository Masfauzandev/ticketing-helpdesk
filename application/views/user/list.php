            ...
            datatable: {
                columns: [
                    ...
                    },
                    {
                        ...
                        data: "last_login",
                        render: function (data) {
                            return data ? '<span class="rel-time" data-value="' + data + '000"></span>' : '<span class="text-muted">Never</span>';
                        }
                    },
                    {
                        title: "IP Address",
                    ...
                    },
                    {
                        ...
                        data: "id",
                        render: function (data, type, row) {
                            return '<a href="' + BASE_URL + 'user/edit_user/' + data + '" class="badge bg-info" title="Edit User"><i class="fa fa-edit"></i></a>';
                        }
                    }
                    // ,
