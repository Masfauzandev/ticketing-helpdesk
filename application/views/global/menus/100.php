...
<li><a href="#usersDropdown" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-users"></i>Master </a>
    <ul id="usersDropdown" class="collapse list-unstyled ">
        ...
        <li><a href="<?= BASE_URL ?>user/add_cabang">Add Cabang</a></li>
        <li><a href="<?= BASE_URL ?>user/add_divisi">Add Divisi</a></li>
        <li><a href="<?= BASE_URL ?>user/add_category">Add Category</a></li>
        <li><a href="<?= BASE_URL ?>user/add_subject">Add Subject</a></li>
    </ul>
</li>
<li><a href="<?= BASE_URL ?>laporan"> <i class="fa fa-file-text-o"></i>Laporan </a></li>
