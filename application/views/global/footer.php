...
<!-- Page Footer-->
<footer class="main-footer" style="background-color:rgb(2, 213, 250);">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <p><?= DEV_COMPANY_NAME ?> &copy; 2025</p>
            </div>
            <div class="col-sm-6 text-right">
                <p>Powered by &nbsp;<a href="<?= BASE_URL ?>" class="external powered-logo"><img
                                src="/tiket-master/assets/img/logo-white.png" width="65" alt="PT. AGA"></a></p>
