...
<div class="page">
    <!-- Main Navbar-->
    <header class="header">
        <nav class="navbar" style="background-color:rgb(2, 130, 250);">
            <!-- Search Box-->
                ...
                <div class="navbar-holder d-flex align-items-center justify-content-between">
                    ...
                    <div class="navbar-header">
                        <!-- Navbar Brand --><a href="<?= BASE_URL ?>user/dashboard" class="navbar-brand d-none d-sm-inline-block">
                            <div class="brand-text d-none d-lg-inline-block">PT. ANUGRAH GASINDO ABADI</div>
                            <div class="brand-text d-none d-sm-inline-block d-lg-none"><strong>AGA</strong></div>
                        </a>
                    ...
                    <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                        <li class="dotted-add-button"><a href="<?= BASE_URL ?>tickets/create_new"><i
                                        class="fa fa-plus-square"></i> Tiket Baru</a></li>
