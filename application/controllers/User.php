	...
	public function profile()
{
    ...
    $user = $this->Users->getUserBy(['username' => $username]);

    if (!$user) {
        // Tampilkan pesan error atau redirect
        show_error("Data user tidak ditemukan untuk username: " . $username, 500);
    }
	...
	public function profile_save()
{
    ...
    // ✅ Ambil ulang user yang sudah di-update
    $updatedUser = $this->Users->getByID($id);

    // ✅ Set ulang ke session
    $this->Session->setSession($updatedUser, "details");
