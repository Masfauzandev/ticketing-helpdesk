...
//Root Url of ur site
define('BASE_URL', 'http://192.168.0.90:8088/tiket-master/');

define('PAGE_LOADER', BASE_URL.'assets/img/loading.webp');

//Client Specific site wide information
define('CLIENT_FNAME','AGA');
define('CLIENT_MNAME','GASINDOGROUP');
define('CLIENT_FULL_NAME', 'PT. ANUGRAH GASINDO GROUP');
define('CLIENT_ADDRESS','IT SUPPORT');
...
define('CLIENT_TICKET_PREFIX', '');
define('CLIENT_TICKET_ID_LENGTH', 1);
