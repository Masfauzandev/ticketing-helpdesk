...
//Root Url of ur site
define('BASE_URL', 'http://localhost/tiket-master/');

define('PAGE_LOADER', BASE_URL.'assets/img/loading.webp');

//Client Specific site wide information
define('CLIENT_FNAME','gasindogroup');
define('CLIENT_MNAME','gasindogroup');
define('CLIENT_FULL_NAME', 'gasindogroup');
define('CLIENT_ADDRESS','tangerang, banten');
define('CLIENT_CONTACT_NO','081218967055');
...
define('CLIENT_TICKET_PREFIX', 'TICKET-');
define('CLIENT_TICKET_ID_LENGTH', 6);

//Client Mail Settings
define('EMAIL_NOTIFICATIONS_ENABLED', true);
define('CLIENT_FROM_EMAIL', 'it_support@gasindogroup.com');
define('CLIENT_HELPDESK_EMAIL', 'groupgasindo@gmail.com');
define('CLIENT_REPLYTO_EMAIL', 'it_support@gasindogroup.com');
define('CLIENT_SMTP_CONFIG', Array(
	'protocol' => 'smtp',
	'smtp_host' => 'mail.gasindogroup.com',
	'smtp_port' => 587,
	'smtp_user' => 'it_support@gasindogroup.com',
	'smtp_pass' => 'bukanrahasia',
	'smtp_crypto' => 'tls',
	'charset'   => 'utf-8',
	'crlf' => '\r\n',
	'mailtype' => 'html',
...
define('CLIENT_DOMAIN', 'gasindogroup.com');
