...
define('DEV_COMPANY_NAME', 'PT.ANUGRAH GASINDO ABADI');
define('DEV_COMPANY_EMAIL', 'marketing@gasindogroup.com');
define('DEV_COMPANY_PHONE', '081218967055');
define('DEV_COMPANY_SUPPORT_EMAIL', 'it_support@gasindogroup.com');
define('DEV_COMPANY_URL', 'www.gasindogroup.com');
define('DEV_COMPANY_LOGO', 'assets/img/logo.png');

/**
 * Product related information
 */
define('PRODUCT_NAME', 'PT.ANUGRAH GASINDO ABADI');
